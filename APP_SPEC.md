...
- **Home** — cycle in the nav subtitle; **Due next** (next cycle’s committed bills from Forecast, up to two cards); Add to the pile; latest 3 receipts. Love Tab / net-this-month / checklist strips are not on Home yet.
