...
**Phase 6 Slice A** — Snapshot + Empire metrics; dashboard reshape + Cycle as-of. **Slice B** — Empire charts + hybrid NW hero (full-width line + selection tooltip). **Next:** C YTD/drift/Money Sleeps.  
